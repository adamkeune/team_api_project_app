...
Experience.create!(start_date: Time.now, end_date: 10.days.from_now, job_title: "Software developer", company_name: "Actualize", details: "", student_id: Student.first.id)
Experience.create(start_date: Time.now, end_date: 10.days.from_now, job_title: "Software developer", company_name: "Actualize", details: "", student_id: Student.first.id)
Experience.create!(start_date: Time.now, end_date: 10.days.from_now, job_title: "Software developer", company_name: "Actualize", details: "", student_id: Student.first.id)

Education.create!(start_date: Time.now, end_date: 10.days.from_now, degree: "Software engineering", university_name: "Actualize", details: "Making apps", student_id: Student.first.id)
Education.create!(start_date: Time.now, end_date: 10.days.from_now, degree: "Software engineering", university_name: "Actualize", details: "Making apps", student_id: Student.first.id)
Education.create!(start_date: Time.now, end_date: 10.days.from_now, degree: "Software engineering", university_name: "Actualize", details: "Making apps", student_id: Student.first.id)

Skill.create!(skill_name: "Rails expert", student_id: Student.first.id)
Skill.create!(skill_name: "Rails expert", student_id: Student.first.id)
Skill.create!(skill_name: "Rails expert", student_id: Student.first.id)

Capstone.create!(name: "Facebook", description: "Cool site where you can post on walls", url: "facebook.com", screenshot_url: "", student_id: Student.first.id)
Capstone.create!(name: "Google", description: "Search everything", url: "google.com", screenshot_url: "", student_id: Student.first.id)
Capstone.create!(name: "Uber", description: "Cabs on your phone", url: "uber.com", screenshot_url: "", student_id: Student.first.id)
